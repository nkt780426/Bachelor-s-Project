...
__all__ = ['iresgroup50', 'iresgroup101']
...
def iresgroup50(pretrained=False, **kwargs):
    ...
    model.load_state_dict(torch.load('/home/vohoang/.cache/torch/pretrained/iresgroup50.pth', weights_only=True))
    return model


def iresgroup101(pretrained=False, **kwargs):
    model = iResGroup(ResGroupBlock, [3, 4, 23, 3], **kwargs)
    model.load_state_dict(torch.load('/home/vohoang/.cache/torch/pretrained/iresgroup101.pth', weights_only=True))
    return model